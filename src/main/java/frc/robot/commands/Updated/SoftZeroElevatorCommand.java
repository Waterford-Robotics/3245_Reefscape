...
// Zeros Elevator (bc internal encs lose precision as time goes on)
public class SoftZeroElevatorCommand extends Command {
  ...
  // Constructor
  public SoftZeroElevatorCommand(ElevatorSubsystem elevatorSubsystem) {
  ...
  public void end(boolean interrupted) {
    ...
    ReactConstants._triggerElevatorReset = false;
  }

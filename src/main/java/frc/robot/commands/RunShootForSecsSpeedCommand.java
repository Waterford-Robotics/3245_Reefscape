...
// Raises Elevator
public class RunShootForSecsSpeedCommand extends Command {
  ...
  // Constructor
  public RunShootForSecsSpeedCommand(IntakeSubsystem intakeSubsystem, double seconds, boolean positioned, double speed) {
